...
import com.exercise.BookstoreAPI.metrics.CountAPIHits;
...
// Go to localhost:8080/admin to access actuator endpoints
// Go to http://localhost:8080/admin/metrics/books_api_hit_count for the custom metric
...
public class BookController {
    ...
    @Autowired
    private CountAPIHits apiHitCounter;
    ...
    public ResponseEntity<List<Book>> getAllBooks(@PathParam("title") String title,
        ...
        // Increment API hits when '/books' is hit
        apiHitCounter.incrementCounter();
